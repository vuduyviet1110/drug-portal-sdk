...
export const DrugPosItemSchema = z.object({
...
export const DrugMasterItemSchema = z.object({
  id: z.string().or(z.number()).transform(val => String(val)),
  tenThuoc: z.string().optional().nullable(),
  soDangKy: z.string().optional().nullable(),
}).passthrough();
...
export const PrescriptionItemSchema = z.object({
  ma_thuoc: z.string().or(z.number()).optional().nullable().transform(val => val !== undefined && val !== null ? String(val) : undefined),
